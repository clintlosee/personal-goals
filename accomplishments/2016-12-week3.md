...
- [x] [Best Practices for Animated Progress Indicators](https://www.smashingmagazine.com/2016/12/best-practices-for-animated-progress-indicators/)
- [x] Finish up CLP site update and migrate to production**
...
- [x] Udemy course reviews
- [x] Delivered gifts to clients
- [x] Drone test flight
- [x] Holiday shopping
- [x] Car maintenance and recall fix
- [x] Set up CLP staging site
...
Still struggling to get the list checked off...