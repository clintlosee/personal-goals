...
- [x] Continue Angular 2 MEAN Starter Project
- [x] [Choose Grunt, Gulp or NPM](https://ponyfoo.com/articles/choose-grunt-gulp-or-npm)
- [x] Get Phones Mailed Off
- [x] Email photography student about her project.
- [x] Free up some hard drive space
...
- [x] Read some of You Don't Know JS Book series
...
Things are getting better so that is great news! Looking to try and pair down this list and get to some of the actual reading 
